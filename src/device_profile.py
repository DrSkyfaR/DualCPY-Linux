...
class DeviceProfile:
    ...
    nickname: str = ""
    # Per-profile extra scrcpy launch arguments (appended after the base args).
    extra_scrcpy_args_top: list = field(default_factory=list)
    extra_scrcpy_args_bottom: list = field(default_factory=list)
